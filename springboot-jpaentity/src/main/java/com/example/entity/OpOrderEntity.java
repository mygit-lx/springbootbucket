 ...
 */
@Entity
@Table(name = "op_order", schema = "iou", catalog = "")
public class OpOrderEntity {
    private int id;
    private String orderId;
    private String orderStatus;
    private Integer orderType;
    private BigDecimal orderAmount;
    private BigDecimal orderAmountFinal;
    ...
    @Basic
    @Column(name = "order_amount_final", nullable = true, precision = 2)
    public BigDecimal getOrderAmountFinal() {
        return orderAmountFinal;
    }

    public void setOrderAmountFinal(BigDecimal orderAmountFinal) {
        this.orderAmountFinal = orderAmountFinal;
    }
    ...
    public boolean equals(Object o) {
        ...
        OpOrderEntity that = (OpOrderEntity) o;
        ...
        if (orderAmountFinal != null ? !orderAmountFinal.equals(that.orderAmountFinal) : that.orderAmountFinal != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (orderAmountFinal != null ? orderAmountFinal.hashCode() : 0);

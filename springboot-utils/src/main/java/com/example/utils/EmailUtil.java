...
public class EmailUtil {
     ...
     * @param smtp 邮件发送服务器
     */
    public EmailUtil(String smtp, String username, String password){
        props = System.getProperties();
    ...
    public static void main(String[] args){
        ...
        String username="qilu_lx@163.com";
        String password="123456";
        String from = "qilu_lx@163.com";
        String[] to = {"936201259@qq.com"};
        String[] copyto = {"936201259@qq.com"};
        String subject = "主题";
        String content = "邮件内容";
        String filename = "E:\\log\\app.log";
        EmailUtil email = new EmailUtil(smtp, username, password);

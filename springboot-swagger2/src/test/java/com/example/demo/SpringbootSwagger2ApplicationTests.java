...
/**
 * SpringbootSwagger2ApplicationTests
 *
 * @author luoxiang
 * @version 1.0
 * @since 2018/3/15
...
@SpringBootTest(classes = SpringbootSwagger2ApplicationTests.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
public class SpringbootSwagger2ApplicationTests {
	...
	private static final Logger LOG = LoggerFactory.getLogger(SpringbootSwagger2ApplicationTests.class);
...
//				.andReturn();
		...
		MvcResult mvcResult = mockMvc.perform(get("/v2/api-docs", "json").accept(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk())
				.andReturn();

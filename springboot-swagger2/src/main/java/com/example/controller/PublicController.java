...
@ApiResponses(value = {
        ...
        @ApiResponse(code = 404,message = "服务请找不到给定的资源，文档不存在"),
...
public class PublicController {
     ...
     * @return 是否入网
     */
    @ApiOperation(value = "入网绑定查询接口",notes = "根据IMEI码来查询该POS机是否入网并绑定<br/>每次打开APP的时候需要调用这个接口来进行检查<br/>如果入网并且绑定了网点才能打开APP，否则必须调用入网或绑定网点接口成功后才能继续下一步",produces = "application/json")
